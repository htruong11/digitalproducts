...
export function renderHero(title: string, subtitle: string): string {
  return `
    <section class="hero">
      <div class="container">
        <div class="hero-copy">
          <span class="eyebrow">Printable PDF for family caregivers</span>
          <h1>${title}</h1>
  ...
  return `
    <div class="product-preview" aria-label="Preview of printable caregiver kit pages">
      ...
      <div class="preview-page page-mid">
        <span>Care Handoff Log</span>
        <i></i><i></i><i></i><i></i>
      </div>
      <div class="preview-page page-front">
        <div class="sheet-top">
          <span>Family Caregiver Command Kit</span>
          <b>PDF</b>
        </div>
  ...
  return `
    <section class="problem">
      <div class="container">
        ...
        <h2>Care coordination usually lives in someone's head.</h2>
  ...
  return `
    <section class="inside" id="inside">
      <div class="container">
        ...
        <h2>A practical kit families can print and use the same day.</h2>
        <p class="section-subtitle">The first product stays intentionally small: printable pages first, optional editable sheet second.</p>
    ...
    <section class="collaborate" id="collaborate">
      <div class="container">
        <div>
          ...
          <p class="section-subtitle">The goal is to learn what is genuinely useful before expanding into more templates, facility tools, or a broader product line.</p>
        </div>
...
export function renderFooter(): string {
  return `
    <footer class="footer">
      <div class="container">
        <p>Family Caregiver Command Kit · ${new Date().getFullYear()}</p>
